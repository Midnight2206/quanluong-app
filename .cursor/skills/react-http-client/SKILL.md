...
description: Guides building or updating a shared React API client with axios interceptors, cookie-based auth, refresh-token retry queue, centralized 401 handling, session logout flow, and service-layer usage outside components.
---
...
- If the app uses TanStack Query or another data layer, keep transport concerns in the shared client and business data fetching in the data layer.
