...
description: Guides building or refactoring React error handling with global error policies, toast notifications, fallback UI boundaries, and clear separation between recoverable user-facing failures and unrecoverable application errors.
---
