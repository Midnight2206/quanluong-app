...
description: Guides building or refactoring backend API contracts with stable route design, unified success and error response shapes, status code rules, pagination and filter params, and clear controller-level boundaries.
---
