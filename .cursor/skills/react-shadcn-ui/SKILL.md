...
description: Guides building or refactoring React UI with shadcn/ui components that consume centralized index.css theme variables, avoid hard-coded visual values, and stay compatible with html.dark class-based theming persisted in localStorage.
---
