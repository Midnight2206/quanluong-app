...
description: Guides building or refactoring React forms with react-hook-form and Zod using schema-based validation, reusable field components, feature-scoped form modules, and maintainable form section extraction.
---
...
- If the form writes to server state, keep transport in services or TanStack Query mutations, not inside field components.
