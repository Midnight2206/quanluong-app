...
description: Guides building or refactoring a Node.js Express backend database layer using MariaDB and Prisma 7 with schema-first modeling, `prisma.config.ts`, Prisma Client adapter setup, explicit migrations, transaction-safe complex operations, direct service access, and strong SQL injection prevention.
---
