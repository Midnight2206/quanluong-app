...
description: Guides building or refactoring a React project using a consistent folder architecture with app-level layout, pages, features, components, hooks, HOCs, services, shared utilities, and strict component extraction rules for reuse and file size.
---
...
- Keep server-state concerns in the data layer (`tanstack-react-query`), not inside presentational components.
