...
description: Guides building or refactoring React pagination flows using either cursor pagination or offset/page pagination, with clear API contract selection, UI state management, and maintainable integration with data fetching layers.
---
...
- integrating pagination with TanStack Query hooks, services, or custom hooks
