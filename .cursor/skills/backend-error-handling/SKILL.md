...
description: Guides building or refactoring backend error handling with domain error types, centralized middleware, normalized error payloads, safe public messages, and one final layer that catches and serializes all thrown failures without crashing the app.
---
