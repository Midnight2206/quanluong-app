...
description: Guides building or refactoring a Node.js Express authentication and authorization system using JWT, session, and httpOnly cookies, with permission-aware route protection and a current-user payload shape aligned with the frontend auth system.
---
