...
description: Guides building or refactoring a modern React UI system with reusable component layers, consistent design patterns, token-driven styling, clear composition rules, and practical guidance for admin and business application interfaces.
---
