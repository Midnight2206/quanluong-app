...
description: Build or refactor a React notification system with toast feedback, in-app notification center, unread badge state, severity levels, and clear separation between transient action messages and persistent system notifications.
---
