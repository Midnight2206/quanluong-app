...
description: Build or refactor React loading and empty states with clear distinction between initial loading, background refreshing, empty results, and content-ready views, while staying aligned with error handling and data-layer status.
---
...
4. Read [references/data-layer-integration.md](references/data-layer-integration.md) when mapping `react-rtk-query`, service, or hook status into UI states.
