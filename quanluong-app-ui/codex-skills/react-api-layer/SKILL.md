...
description: Build or refactor a React API layer with shared transport usage, domain-based endpoint modules, request and response adaptation, error normalization, and clean separation from UI and state orchestration.
---
...
- If the project uses RTK Query, API layer concerns may live inside endpoint definitions, but the same rules still apply.
