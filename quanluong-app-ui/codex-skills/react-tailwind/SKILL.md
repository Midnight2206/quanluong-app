---
name: react-tailwind
description: Build or refactor React UI with Tailwind CSS using centralized CSS variables in index.css, class-based dark mode on the html element, localStorage theme persistence, and token-first styling instead of hard-coded values.
---
