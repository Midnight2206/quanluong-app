...
description: Build or refactor a Node.js Express queue system using Redis and BullMQ so long-running or non-immediate tasks are processed asynchronously without blocking user requests, with clear service-to-queue boundaries and worker handling.
---
