...
description: Build or refactor Docker setup for a Node.js Express JavaScript backend using Dockerfile, docker-compose, environment-driven configuration, and coordinated containers for app, MariaDB, Redis, and Prisma workflows.
---
