...
description: Build or refactor a backend audit-log system for important business actions with actor tracking, entity references, safe payload logging, transaction-aware persistence, and reviewable event semantics.
---
