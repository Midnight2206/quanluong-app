...
description: Build or refactor domain modules in a Node.js Express JavaScript backend using a consistent per-module shape with routes, controllers, services, validators, mappers, Prisma-aware boundaries, and native ESM modules.
---
