...
description: Build or refactor Express controller-layer code in JavaScript so controllers only receive requests, call services, and send HTTP responses, without owning business logic or direct database access.
---
