...
description: Build or refactor backend security middleware in a Node.js Express JavaScript app using rate limiting, CORS, Helmet, and input sanitization with clear request-boundary protections and safe defaults.
---
