...
description: Build or refactor a backend scheduling system for automatic recurring tasks, with clear separation between time-based triggers, business services, and BullMQ queue execution in Node.js Express apps.
---
