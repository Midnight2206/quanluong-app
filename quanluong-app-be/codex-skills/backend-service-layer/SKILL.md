...
description: Build or refactor backend service-layer logic with clear business orchestration, Prisma coordination, transaction ownership, side-effect management, and framework-independent domain behavior.
---
