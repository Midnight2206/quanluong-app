      ...
      <CardContent className="flex min-h-0 flex-1 flex-col gap-3 !px-0 !py-3 sm:!p-4">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden px-3 lg:flex-row lg:gap-4 lg:px-0">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <div
              data-local-scroll="true"
              className="-mx-3 min-h-0 flex-1 space-y-2 overflow-y-auto overscroll-y-contain rounded-none border border-y border-border/70 border-x-0 bg-muted/10 p-2 sm:mx-0 sm:rounded-lg sm:border-x sm:p-3"
            >
              {moduleKeys.map((mod) => {
