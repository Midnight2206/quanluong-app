...
function classifyCommodityCalcMode(measureUnit) {
  return SHARED_UNITS.has(normalizeMeasureUnit(measureUnit)) ? "per_unit_shared" : "per_person";
}
...
export { classifyCommodityCalcMode, computeLineTotalQuantity, normalizeMeasureUnit };
